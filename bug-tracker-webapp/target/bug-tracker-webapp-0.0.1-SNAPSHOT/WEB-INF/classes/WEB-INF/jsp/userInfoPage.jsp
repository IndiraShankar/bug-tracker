...
<body>
 ...
 <div  class="form" >
	<form:form method="post" action="addGenie" commandName="genieForm" onsubmit="return validate()">
		...
		<br>
			genieType  <form:select path="genieType"  id="genieType"  onchange="assignPerson(this.value)">
		...
		<br>
			...
			assignedTo <form:input path="assignedTo.username" id="assignedTo" readonly="true"/>
		<br>
